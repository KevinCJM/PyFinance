    ...
    test_json = {
        "configs": [
            {"cpkAmount": 1000000.0,  # 总可用投资金额??????
             ...
             "products": [  # 9个可投资产品的详细信息
                 {
                     "incAmt": 1.00,
                     "amount": 0.00,  # 起购金额
                     "productId": "019B310006",  # 产品ID
                     "worstRate": 0.016315999999999997,  # 业绩比较基准下限
                     "level": 5.0,  # 产品评级
                     "ywlxdm": "LC",  # 自定义分类
                     "bestRate": 0.027684,  # 业绩比较基准上限
                     "incAmount": 1.00,  # 递增金额
                     "productName": "添利新私享",  # 产品名称
                     "openEndDate": "20991231",
                     "privateVisible": 0,  # 是否面向合格投资者
                     "badPosAmt": 0.00,
                     "zgcyje": 10000000.00,  # 最高持有金额
                     "rjdy": "01002",  # 二级分类码值
                     "sjdy": "01002002",  # 三级分类码值
                     "closeDays": 1.0,  # 产品周期/久期/封闭期
                     "risk": "1",  # 风险等级, 代码中会被处理为: R1-R5
                     "isRecomm": False,  # 重点推荐
                     "clazz": "01",  # 大类资产码值
                     "yjdy": "01",  # 一级分类码值
                     "fixProductId": "019B310006$^a002c30439c4bb3af4bc0823ee633b0",
                     "baseRate": 0.022,  # 基准指数收益率
                     "baseCode": "H11025.CSI",  # 基准指数代码
                     # "prio": None,  # 产品优先度
                     # "cpcsjg": 0,   # 产品创设机构: 0=无 1=财富 2=私行
                     # "planType": '', # 专属场景类型
                 },
                 {
                     "incAmt": 100.00,
             ...
             "rf": 0.0175,
             "productsContRangeInOneCpk": [1, 12],
             "risk": 6,
             "portfolio_num": 1,
             "intereScoreDict": {}  # 兴趣评分
             }
        ],
