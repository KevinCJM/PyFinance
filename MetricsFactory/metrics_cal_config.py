...
log_return_metrics_dict = {
    'TotalReturn':
        ['总收益率',  # 指标名称
         ...
         # 支持计算的区间
         ['2d', '3d', '5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y', '3y', '5y'],
         ],
    'AnnualizedReturn':
        ['年化收益率',
         '年化收益率 = (1 + 总收益率)^(return_ann_factor/天数) - 1',
         ['5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y', '3y', '5y'],
         ],
    'AverageDailyReturn':
        ['日均收益率',
         '日均收益率 = 总收益率 / 交易天数',
    ...
    'MeanAbsoluteDeviation':
        ['平均绝对偏差',
         ...
         ['3d', '5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y', '3y', '5y'],
         ],
    'ReturnRange':
        ['收益率范围, 也称为极差',
    ...
    'VaR-99':
        ['99% VaR',
         ...
         ['10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y', '3y', '5y'],
         ],
    'VaR-95':
        ['95% VaR',
    ...
    'VolAvg':
        ['平均成交量',
         '平均成交量 = 过去N天的平均成交量',
         ['5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m'],
         ],
    'VolSlope':
        ['成交量斜率',
    ...
    'MaxHigh':
        ['最高价',
         '最高价 = 过去N天的最高价',
         ['2d', '5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m'],
         ],
    'MinLow':
        ['最低价',
         '最低价 = 过去N天的最低价',
...
rolling_metrics = {
    ...
    'RSI':
        ['RSI 指标 (相对强弱指数)',
         ...
         [6, 8, 9, 10, 12, 13, 18, 23, 24, 26],  # 滚动天数
         ],
    'OBV':
        ['OBV 指标 (能量潮指标)',
    ...
    'CCI':
        ['CCI 指标 (顺势指标)',
         ...
         [3, 5, 7, 9, 12, 14, 19, 25],  # 滚动天数
         ],
    'CR':
        ['CR 指标 (CurrentRatio 现价能量强度指标)',
         'CR = (当日最高价 - 昨日中间价) / (昨日中间价 - 当日最低价)',
         [3, 5, 7, 9, 12, 14, 19, 26, 35],  # 滚动天数
         ],
    'MACR-10-5':    # 'MACR-10-5' 与 'MACR-20-9' 构成的区间叫做 '副地震带'
        ['CR指标的N移动平均往后移动M天',
         'CR指标的移动平均 = CR的10日移动平均后移5天',
         [3, 5, 7, 9, 12, 14, 19, 26, 35],  # 滚动天数
         ],
    'MACR-20-9':    # 'MACR-10-5' 与 'MACR-20-9' 构成的区间叫做 '副地震带'
        ['CR指标的N移动平均往后移动M天',
         'CR指标的移动平均 = CR的20日移动平均后移9天',
         [3, 5, 7, 9, 12, 14, 19, 26, 35],  # 滚动天数
         ],
    'MACR-40-17':   # 'MACR-40-17' 与 'MACR-62-28' 构成的区间叫做 '主地震带'
        ['CR指标的N移动平均往后移动M天',
         'CR指标的移动平均 = CR的40日移动平均后移17天',
         [3, 5, 7, 9, 12, 14, 19, 26, 35],  # 滚动天数
         ],
    'MACR-62-28':   # 'MACR-40-17' 与 'MACR-62-28' 构成的区间叫做 '主地震带'
        ['CR指标的N移动平均往后移动M天',
