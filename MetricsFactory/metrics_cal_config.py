...
log_return_metrics_dict = {
    'TotalReturn':
        ['总收益率',  # 指标名称
         ...
         # 支持计算的区间
         ['2d', '3d', '5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y'],
         ],
    'AnnualizedReturn':
        ['年化收益率',
         '年化收益率 = (1 + 总收益率)^(return_ann_factor/天数) - 1',
         ['5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y'],
         ],
    'AverageDailyReturn':
        ['日均收益率',
         '日均收益率 = 总收益率 / 交易天数',
    ...
    'MeanAbsoluteDeviation':
        ['平均绝对偏差',
         ...
         ['3d', '5d', '10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y'],
         ],
    'ReturnRange':
        ['收益率范围, 也称为极差',
    ...
    'VaR-99':
        ['99% VaR',
         ...
         ['10d', '15d', '25d', '50d', '75d', '5m', '6m', '9m', '12m', '2y'],
         ],
    'VaR-95':
        ['95% VaR',
